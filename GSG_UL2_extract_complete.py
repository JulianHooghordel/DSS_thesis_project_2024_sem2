...
# Define parameters
####################################################################################################################################################################################################################
full_df_path = "data/dataset_1990_sum_big_complete_extract_768.csv"
complete_eclis_path = "data/ecli_series/ecli_dataset_1990_sum_complete.csv"

text_column = "extractive_summary"
summary_column = "inhoudsindicatie"

max_gen_length = 2048

model_name = "models/UL2-base-dutch-rechtspraak"

output_dir = "models/GSG_UL2_extract_complete"
...
# Drop the rows with None values in the text column
